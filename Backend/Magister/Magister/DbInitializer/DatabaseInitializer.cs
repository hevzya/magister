        ...
        public async Task SeedData()
        {
            ...
            var lessons = new List<Lesson>()
            {
                new Lesson
                {
                    ...
                    Duration = 60,
                    Group = await _context.Groups.FirstOrDefaultAsync(x => x.GroupName == "1-A"),
                    LessonStartDate = new DateTime(2023, 10, 1, 16,0,0).ToUniversalTime(),
                ...
                new Lesson
                {
                    ...
                    Duration = 90,
                    Group = await _context.Groups.FirstOrDefaultAsync(x => x.GroupName == "1-B"),
                    LessonStartDate = new DateTime(2023, 10, 2).ToUniversalTime(),
                ...
                new Lesson
                {
                    ...
                    Duration = 75,
                    Group = await _context.Groups.FirstOrDefaultAsync(x => x.GroupName == "2-A"),
                    LessonStartDate = new DateTime(2023, 10, 3).ToUniversalTime(),
